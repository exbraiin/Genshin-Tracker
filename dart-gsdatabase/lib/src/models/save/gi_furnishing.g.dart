...
class GiFurnishing extends _GiFurnishing {
  ...
  GiFurnishing({required this.id, required this.amount});
  ...
  @override
  GiFurnishing copyWith({String? id, int? amount}) {
    return GiFurnishing(id: id ?? this.id, amount: amount ?? this.amount);
  }
