...
class GsItemBanner {
  ...
  factory GsItemBanner.isNewOrUpcoming(BuildContext context, String version) {
  ...
  factory GsItemBanner.version(BuildContext context, String version) {
...
class GsItemCardLabel extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    late final dBgColor = context.themeColors.mainColor0.withValues(alpha: 0.6);
